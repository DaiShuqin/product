<template>
  <div>
    <div class="b_btm_bg b_btm_c" id="footer">
      <div class="b_btm">
        <table border="0" style="width:210px; height:62px; float:left; margin-left:75px; margin-top:30px;" cellspacing="0" cellpadding="0">
          <tr>
            <td width="72"><img :src="url+'/b1.png'" width="62" height="62" /></td>
            <td><h2>正品保障</h2>正品行货  放心购买</td>
          </tr>
        </table>
        <table border="0" style="width:210px; height:62px; float:left; margin-left:75px; margin-top:30px;" cellspacing="0" cellpadding="0">
          <tr>
            <td width="72"><img :src="url+'/b2.png'" width="62" height="62" /></td>
            <td><h2>满38包邮</h2>满38包邮 免运费</td>
          </tr>
        </table>
        <table border="0" style="width:210px; height:62px; float:left; margin-left:75px; margin-top:30px;" cellspacing="0" cellpadding="0">
          <tr>
            <td width="72"><img :src="url+'/b3.png'" width="62" height="62" /></td>
            <td><h2>天天低价</h2>天天低价 畅选无忧</td>
          </tr>
        </table>
        <table border="0" style="width:210px; height:62px; float:left; margin-left:75px; margin-top:30px;" cellspacing="0" cellpadding="0">
          <tr>
            <td width="72"><img :src="url+'/b4.png'" width="62" height="62" /></td>
    ...
    <div class="b_nav">
      ...
      <div class="b_tel_bg'">
        <div class="b_er" style="width: 120px;
    height: 160px;
    overflow: hidden;
    text-align: center;
    float: right;
    ...
    margin-right: 22px;
    margin-top: 5px;">
          <div class="b_er_c"><img :src="url+'/er.gif'" width="118" height="118" /></div>
          <img :src="url+'/ss.png'" />
        </div>
        <a href="#" class="b_sh1"><el-image :src="url+'/b_sh_1.png'"/> 新浪微博</a><br>
        <a href="#" class="b_sh2"><el-image :src="url+'/b_sh_2.png'"/> 腾讯微博</a>
        <p>
          服务热线：<br />
          <span style="color: #ff4e00;">400-123-4567</span>
        </p>
      </div>
    ...
    <div class="btmbg'">
      <div class="btm">
        ...
        <img :src="url+'/b_1.gif'" width="98" height="33" /><img :src="url+'/b_2.gif'" width="98" height="33" /><img :src="url+'/b_3.gif'" width="98" height="33" /><img :src="url+'/b_4.gif'" width="98" height="33" /><img :src="url+'/b_5.gif'" width="98" height="33" /><img :src="url+'/b_6.gif'" width="98" height="33" />
      </div>
    </div>
  </div>
</template>
...
<style scoped>
  ...
  .s_city {
    height: 35px;
    background: url(http://127.0.0.1:89/productimg/t_arrow.gif) no-repeat right center;
    float: left;
    padding-right: 15px;
    cursor: pointer;
    position: relative;
  ...
  .s_city_t {
    ...
    line-height: 7px;
    overflow: hidden;
    background: url(http://127.0.0.1:89/productimg/c_t.gif) no-repeat center top;
    position: absolute;
    left: 55px;
    top: 0;
  }
  ...
  .s_sh a.sh1 {
    background: url(http://127.0.0.1:89/productimg/sh1.png) no-repeat center 8px;
  }

  .s_sh a.sh2 {
    background: url(http://127.0.0.1:89/productimg/sh2.png) no-repeat center center;
  }
  ...
  .i_car {
    ...
    height: 38px;
    line-height: 38px;
    background: url(http://127.0.0.1:89/productimg/car.png) no-repeat 10px center;
    background-color: #f6f6f6;
    float: right;
    margin-top: 50px;
  ...
  .car_t {
    ...
    height: 38px;
    overflow: hidden;
    background: url(http://127.0.0.1:89/productimg/d_arrow.png) no-repeat right center;
    font-size: 14px;
    margin-left: 38px;
    cursor: pointer;
  }
  ...
  .price_a {
    ...
    line-height: 35px;
    overflow: hidden;
    background: url(http://127.0.0.1:89/productimg/a_link.gif) repeat-x center top;
    color: #FFF;
    font-size: 14px;
    text-align: center;
    margin-right: 13px;
  ...
  .leftNav ul li {
    height: 40px;
    line-height: 40px;
    background: url(http://127.0.0.1:89/productimg/n_arrow.gif) no-repeat 195px center;
    color: #FFF;
    font-size: 14px;
    margin-left: 1px;
    cursor: pointer;
  ...
  .leftNav ul li ul {
    ...
    min-height: 70px;
    overflow: hidden;
    background: url(http://127.0.0.1:89/productimg/nav_bg.png) repeat center top;
    position: absolute;
    left: 196px;
    top: 0px;
  ...
  .banner .op_btns .op_prev {
    background: url(http://127.0.0.1:89/productimg/b_left.png) no-repeat center top;
    left: 0;
    top: 420px;
  }

  .banner .op_btns .op_next {
    background: url(http://127.0.0.1:89/productimg/b_right.png) no-repeat center top;
    right: 0;
    top: 420px;
  }
  ...
  .banner .bx-wrapper .bx-controls .bx-pager a {
    ...
    overflow: hidden;
    margin: 15px 5px;
    background: url(http://127.0.0.1:89/productimg/b.png) no-repeat center top;
  }

  .banner .bx-wrapper .bx-controls .bx-pager a:hover, .banner .bx-wrapper .bx-controls .bx-pager a.active {
    background: url(http://127.0.0.1:89/productimg/b_h.png) no-repeat center top;
  }
  ...
  .banner .ul_change_a2 span{
    width:10px; height:10px; line-height:10px; overflow:hidden; float:left; text-align:center; background:url(http://127.0.0.1:89/productimg/b.png) no-repeat center top;
  }
  .banner .ul_change_a2 span.on { background:url(http://127.0.0.1:89/productimg/b_h.png) no-repeat center top; }*/
  ...
  .ch_t_icon {
    ...
    line-height: 7px;
    overflow: hidden;
    background: url(http://127.0.0.1:89/productimg/d_a.gif) no-repeat center top;
    position: absolute;
    left: 28px;
    top: 39px;
  }
  ...
  .jslct {
    ...
    *display: inline;
    ...
    vertical-align: middle;
    cursor: default;
    background: url(http://127.0.0.1:89/productimg/d_arrow.png) no-repeat 97px center;
    float: left;
    border: 1px solid #d9d9d9;
  }
  ...
  .hot_pro .featureBox {
    ...
    height: 228px;
    overflow: hidden;
    background: url(http://127.0.0.1:89/productimg/line.gif) no-repeat right 122px;
    float: left;
  ...
  .i_sell #imgPlay .btn a {
    ...
    overflow: hidden;
    display: block;
    background: url(http://127.0.0.1:89/productimg/b_left.png) no-repeat;
  }
  ...
  .i_sell #imgPlay .previ {
    ...
    height: 40px;
    overflow: hidden;
    background: url(http://127.0.0.1:89/productimg/s_left.png) no-repeat;
    cursor: pointer;
    text-indent: -9999px;
    position: absolute;
    left: 0;
  ...
  .i_sell #imgPlay .nexti {
    ...
    height: 40px;
    overflow: hidden;
    background: url(http://127.0.0.1:89/productimg/s_right.png) no-repeat;
    cursor: pointer;
    text-indent: -9999px;
    position: absolute;
    right: 0;
  ...
  .s_name {
    ...
    height: 60px;
    overflow: hidden;
    background: url(http://127.0.0.1:89/productimg/name.png) repeat-x center top;
    text-align: center;
    position: absolute;
    left: 0;
    bottom: 0;
  ...
  .floor_num {
    ...
    line-height: 40px;
    overflow: hidden;
    background: url(http://127.0.0.1:89/productimg/floor.png) no-repeat center top;
    color: #FFF;
    font-size: 14px;
    text-transform: uppercase;
    text-indent: 6px;
  ...
  .fresh_txt {
    width: 211px;
    height: 155px;
    background: url(http://127.0.0.1:89/productimg/s_txt.png) no-repeat center top;
    padding-top: 1px;
  }
  ...
  .l_user {
    ...
    line-height: 38px \9;
    overflow: hidden;
    background: url(http://127.0.0.1:89/productimg/i_u.png) no-repeat 285px center;
    background-color: #FFF;
    color: #888888;
    font-size: 14px;
    font-family: "Microsoft YaHei";
  ...
  .l_pwd {
    ...
    line-height: 38px \9;
    overflow: hidden;
    background: url(http://127.0.0.1:89/productimg/i_pwd.png) no-repeat 285px center;
    background-color: #FFF;
    color: #888888;
    font-size: 14px;
    font-family: "Microsoft YaHei";
  ...
  .l_email {
    ...
    line-height: 38px \9;
    overflow: hidden;
    background: url(http://127.0.0.1:89/productimg/i_email.png) no-repeat 285px center;
    background-color: #FFF;
    color: #888888;
    font-size: 14px;
    font-family: "Microsoft YaHei";
  ...
  .l_mem {
    ...
    line-height: 38px \9;
    overflow: hidden;
    background: url(http://127.0.0.1:89/productimg/i_mem.png) no-repeat 285px center;
    background-color: #FFF;
    color: #888888;
    font-size: 14px;
    font-family: "Microsoft YaHei";
  ...
  .l_num {
    ...
    line-height: 38px \9;
    overflow: hidden;
    background: url(http://127.0.0.1:89/productimg/i_num.png) no-repeat 285px center;
    background-color: #FFF;
    color: #888888;
    font-size: 14px;
    font-family: "Microsoft YaHei";
  ...
  .log_btn {
    ...
    line-height: 42px \9;
    overflow: hidden;
    background: url(http://127.0.0.1:89/productimg/btn_log.gif) repeat-x center top;
    color: #FFF;
    font-size: 16px;
    font-family: "Microsoft YaHei";
    text-align: center;
  ...
  .his_t {
    ...
    line-height: 38px;
    overflow: hidden;
    background: url(http://127.0.0.1:89/productimg/h_t.gif) no-repeat 10px center;
    color: #ff4e00;
    font-size: 16px;
    padding-left: 22px;
    padding-right: 10px;
  ...
  .list_or .i_up {
    ...
    line-height: 8px;
    overflow: hidden;
    background: url(http://127.0.0.1:89/productimg/i_up.gif) no-repeat center top;
    text-indent: -9999em;
    float: right;
    margin-top: 6px;
    margin-right: 8px;
  ...
  .list_or .i_down {
    ...
    line-height: 8px;
    overflow: hidden;
    background: url(http://127.0.0.1:89/productimg/i_down.gif) no-repeat center top;
    text-indent: -9999em;
    float: right;
    margin-top: 0px;
    margin-right: 8px;
  ...
  ul.cate_list li .carbg a.ss {
    ...
    line-height: 28px;
    overflow: hidden;
    background: url(http://127.0.0.1:89/productimg/heart.png) no-repeat 10px center;
    color: #888888;
    text-indent: 33px;
    float: left;
    display: inline;
  ...
  ul.cate_list li .carbg a.ss:hover {
    color: #888888;
    background: url(http://127.0.0.1:89/productimg/heart_h.png) no-repeat 10px center;
  }
  ...
  ul.cate_list li .carbg a.j_car {
    ...
    line-height: 28px;
    overflow: hidden;
    background: url(http://127.0.0.1:89/productimg/cars.png) no-repeat 24px center;
    color: #ff4e00;
    text-indent: 47px;
    float: left;
    display: inline;
  ...
  ul.cate_list li .carbg a.j_car:hover {
    color: #FFF;
    background: url(http://127.0.0.1:89/productimg/cars_h.png) no-repeat 24px center;
    background-color: #ff4e00;
  ...
  .brand_t {
    ...
    line-height: 40px;
    overflow: hidden;
    background: url(http://127.0.0.1:89/productimg/h_t.gif) no-repeat left center;
    color: #ff4e00;
    font-size: 16px;
    padding-left: 14px;
  }
  ...
  .des_choice ul li .ch_img {
    ...
    height: 18px;
    overflow: hidden;
    background: url(http://127.0.0.1:89/productimg/ch.png) no-repeat center top;
    position: absolute;
    right: 0;
    bottom: 0;
    display: none;
  ...
  .des_share .d_sh {
    ...
    height: 27px;
    line-height: 27px;
    background: url(http://127.0.0.1:89/productimg/sh.png) no-repeat 12px 5px;
    text-indent: 32px;
    font-family: "宋体";
    float: left;
  ...
  .des_share .d_care {
    ...
    line-height: 27px;
    overflow: hidden;
    background: url(http://127.0.0.1:89/productimg/care.png) no-repeat left center;
    float: left;
    display: inline;
    margin-left: 50px;
    padding-left: 22px;
  ...
  .n_btn_1 {
    ...
    height: 21px;
    overflow: hidden;
    background: url(http://127.0.0.1:89/productimg/jia.gif) no-repeat center top;
    float: right;
    border: 0;
  ...
  .n_btn_2 {
    ...
    height: 21px;
    overflow: hidden;
    background: url(http://127.0.0.1:89/productimg/jian.gif) no-repeat center top;
    float: right;
    border: 0;
    border-left: 1px solid #cccccc;
    cursor: pointer;
  ...
  .jud_bg {
    background: url(http://127.0.0.1:89/productimg/s_line.gif) no-repeat left center;
    padding: 0 30px;
    font-family: "宋体";
    line-height: 22px;
  }
  ...
  .black_overlay {
    width: 100%;
    height: 100%;
    background: url(http://127.0.0.1:89/productimg/box_bg.png) repeat center top;
    display: none;
    position: fixed;
    top: 0%;
    left: 0%;
  ...
  .white_content {
    ...
    min-height: 100px;
    height: 100px;
    background: url(http://127.0.0.1:89/productimg/box.png) repeat center top;
    display: none;
    position: fixed;
    top: 30%;
    left: 50%;
  ...
  .sell_ban #imgPlays .next_s {
    ...
    height: 60px;
    overflow: hidden;
    background: url(http://127.0.0.1:89/productimg/b_right.png) no-repeat;
    cursor: pointer;
    text-indent: -9999px;
    position: absolute;
    right: 0;
  ...
  .h_more {
    height: 43px;
    overflow: hidden;
    background: url(http://127.0.0.1:89/productimg/mores.png) no-repeat right center;
    font-size: 12px;
    padding-right: 22px;
  }
  ...
  .lim_sh {
    height: 30px;
    line-height: 30px;
    background: url(http://127.0.0.1:89/productimg/sh.png) no-repeat left 8px;
    text-indent: 20px;
    font-family: "宋体";
    float: left;
    display: inline;
  ...
  .lim_clock {
    width: 250px;
    overflow: hidden;
    background: url(http://127.0.0.1:89/productimg/clock.png) no-repeat left 2px;
    padding-left: 25px;
    margin-top: 15px;
  }
  ...
  .left_n {
    ...
    line-height: 35px;
    overflow: hidden;
    background: url(http://127.0.0.1:89/productimg/m_t.png) no-repeat 31px center;
    background-color: #ff4e00;
    color: #FFF;
    font-size: 14px;
    text-indent: 68px;
  ...
  .t_bg1 {
    background: url(http://127.0.0.1:89/productimg/m_i_1.png) no-repeat 31px center;
  }

  .t_bg2 {
    background: url(http://127.0.0.1:89/productimg/m_i_2.png) no-repeat 31px center;
  }

  .t_bg3 {
    background: url(http://127.0.0.1:89/productimg/m_i_3.png) no-repeat 31px center;
  }

  .t_bg4 {
    background: url(http://127.0.0.1:89/productimg/m_i_4.png) no-repeat 31px center;
  }
  ...
  .m_notice {
    ...
    line-height: 35px;
    overflow: hidden;
    background: url(http://127.0.0.1:89/productimg/n_not.png) no-repeat left center;
    padding-left: 32px;
  }
  ...
  .order_tab .jslct {
    ...
    *display: inline;
    ...
    vertical-align: middle;
    cursor: default;
    background: url(http://127.0.0.1:89/productimg/d_arrow.png) no-repeat 170px center;
    background-color: #f6f6f6;
    float: left;
    border: 1px solid #d9d9d9;
  }
  ...
  .add_tab .jslct {
    ...
    *display: inline;
    ...
    vertical-align: middle;
    cursor: default;
    background: url(http://127.0.0.1:89/productimg/d_arrow.png) no-repeat 88px center;
    background-color: #f6f6f6;
    float: left;
    border: 1px solid #d9d9d9;
    margin-right: 10px;
  ...
  ul.members li .nums {
    ...
    height: 38px;
    overflow: hidden;
    background: url(http://127.0.0.1:89/productimg/peo.png) no-repeat center 20px;
    background-color: #f6f6f6;
    text-align: center;
    float: left;
    padding-top: 50px;
  ...
  ul.members li:hover .nums {
    background: url(http://127.0.0.1:89/productimg/peo_h.png) no-repeat center 20px;
    background-color: #ff4e00;
    color: #FFF;
  ...
  .th_bg {
    overflow: hidden;
    background: url(http://127.0.0.1:89/productimg/peo_h.png) no-repeat 15px center;
    background-color: #ff4e00;
    text-align: left;
    color: #FFF;
    font-size: 14px;
  ...
  .b_tel_bg a.b_sh1 {
    ...
    line-height: 35px;
    overflow: hidden;
    background: url(http://127.0.0.1:89/productimg/b_sh_1.png) no-repeat left center;
    color: #888888;
    font-size: 14px;
    text-indent: 32px;
    display: inline-block;
  ...
  .b_tel_bg a.b_sh2 {
    ...
    line-height: 35px;
    overflow: hidden;
    background: url(http://127.0.0.1:89/productimg/b_sh_2.png) no-repeat left center;
    color: #888888;
    font-size: 14px;
    text-indent: 32px;
    display: inline-block;
