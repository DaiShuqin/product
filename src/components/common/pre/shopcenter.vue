               ...
               <div class="row">
                 <div class="col-xs-2 col-xs-offset-2">
                   <div class="list-group">
                     <!--生成路由链接-->
                     <router-link to="/mywallet" class="list-group-item">mywallet</router-link>
             ...
             <el-col>
               <el-menu>
                 <el-menu-item index="1">
                   ...
                   <router-link to="/index" class="list-group-item">我的钱包</router-link>
                 </el-menu-item>
                 <el-menu-item index="2">
                   <i class="el-icon-s-custom"></i>
                   <router-link to="/about" class="list-group-item">账户设置</router-link>
                 </el-menu-item>
                 <el-menu-item index="3">
                   <i class="el-icon-document"></i>
                   <router-link to="/about" class="list-group-item">交易管理</router-link>
                 </el-menu-item>
                 <el-menu-item index="4">
                   <i class="el-icon-user"></i>
                   <router-link to="/about" class="list-group-item">用户服务</router-link>
                 </el-menu-item>
               </el-menu>
             </el-col>
           </el-aside>
