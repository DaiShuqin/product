          ...
          <el-form id="register" :model="queryParams" :rules="rules" ref="queryParams">
            <table border="0" style="width:420px; font-size:14px; margin-top:20px;" cellspacing="0" cellpadding="0">
              ...
              <tr height="70" id="pro" name="pro" style="display:none">
                ...
                <td>
                  <input type="text" v-model="query.password" value="" name="mobile" class="l_tel1"/>
                  <el-button @click="updateUserPwd">点击修改</el-button>
                </td>
              </tr>
...
<script>
  ...
  import {retrievepwd,updateUserpwd} from "@/api/product/retrieve"
  export default {
    name: "register",
    data() {
      return {
    ...
    methods:{
      ...
      registerUser(){
         ...
         */
        retrievepwd(this.queryParams).then(response =>{
      ...
      updateUserPwd(){
        ...
        updateUserpwd(this.query).then(response =>{
          if(response.data.retCode=="666"){
            alert(response.data.MsgCode)
            this.$router.push({path:"/login"});
          }else{
