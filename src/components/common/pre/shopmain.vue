  ...
  <el-row>
    <el-col :span="24" :xs="24">
      <el-form :model="queryParams" ref="queryForm" :inline="true" label-width="100px">
        ...
        <el-form-item>
          <el-button type="primary" icon="el-icon-search" size="mini" @keyup.enter="handleQuerya" @click="handleQuerya">搜索</el-button>
        </el-form-item>
      </el-form>
      <div class="content mar_20" style="background-color: #ff4e00;">
        <ul class="menu_r" style="">
          <li><a @click="index(0)">首页</a></li>
          <li v-for="item in catelist" :key="item"><a @click="getList(item.id)">{{item.name}}</a></li>
        </ul>
...
<!--      <table align="center" bgcolor="#7fffd4" width="80%">-->
<!--        <tr>-->
<!--          <td v-for="item in goodslist" :key="item">-->
<!--            <img :src="url +item.filename" width="50px" height="50px">-->
<!--            <ul v-loading="loading" :data="item">-->
<!--              <li label="商品名称" align="center" prop="" >名称：{{item.goodsName}}</li><br/>-->
<!--              <li label="商品库存" align="center" prop="" >库存：{{item.stock}}</li><br/>-->
<!--              <li label="商品价格" align="center" prop="" >价格：{{item.price}}</li>-->
<!--            </ul>-->
<!--          </td>-->
<!--        </tr>-->
<!--      </table>-->
...
<script>
  import {listgoods} from "@/api/product/index";
